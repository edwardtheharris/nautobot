...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("NAUTOBOT_DB_PASSWORD", "xQWdPGgsg7weMon7MoLNiDp*PEx-46qq"),  # Database password
        "HOST": os.getenv("NAUTOBOT_DB_HOST", "psql"),  # Database server
...
SECRET_KEY = os.getenv("NAUTOBOT_SECRET_KEY", "@k^yft9*7=2#5s6xyi*xuvv_jtaz5fl651_pdbu!ophcu!^i+i")
